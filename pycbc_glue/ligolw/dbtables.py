...
class DBTable(table.Table):
	...
	If a custom pycbc_glue.ligolw.Table subclass is defined in
	pycbc_glue.ligolw.lsctables whose name matches the name of the DBTable
	...
	def copy(self, *args, **kwargs):
		...
		pycbc_glue.ligolw.table.Table for more information.
		"""

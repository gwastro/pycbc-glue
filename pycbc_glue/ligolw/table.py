...
def new_from_template(template):
	...
	"""
	import warnings
	warnings.warn("pycbc_glue.ligolw.table.new_from_template() is deprecated.  Use .copy() method of Table instances instead.", DeprecationWarning)
...
class Column(ligolw.Column):
	...
	<pycbc_glue.ligolw.table.TableStream object at ...>

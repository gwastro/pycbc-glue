...
simply include the lines
	...
	pycbc_glue.ligolw.types.FormatFunc.update({
		"real_4": u"%.9g".__mod__,
		"real_8": u"%.17g".__mod__,
		"float": u"%.9g".__mod__,
		"double": u"%.17g".__mod__,
		u"complex_8": pycbc_glue.ligolw.types.mk_complex_format_func(u"%.9g"),
		u"complex_16": pycbc_glue.ligolw.types.mk_complex_format_func(u"%.17g")
	})
...
pycbc_glue.ligolw XML writing codes.
"""
...
pycbc_glue.ligolw XML parsing codes.
"""
...
array type strings.  Used by pycbc_glue.ligolw array reading codes.
"""
...
data type strings.  Uesd by pycbc_glue.ligolw array writing codes.
"""
